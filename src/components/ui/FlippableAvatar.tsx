...
export function FlippableAvatar({ size = 'medium', showHint = false }: FlippableAvatarProps) {
  ...
  return (
    <div className="relative inline-block">
      <div 
        className={`${sizeClasses[size]} mx-auto cursor-pointer perspective-1000`}
        onClick={handleFlip}
      >
        <div 
        ...
        >
          ...
          <div 
            className="absolute inset-0 backface-hidden rounded-full shadow-2xl overflow-hidden border-4 border-white/30"
