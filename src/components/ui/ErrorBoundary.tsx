          ...
          <div className="bg-white rounded-3xl shadow-2xl border-4 border-[#FFB6C1] p-6 md:p-8 lg:p-12 max-w-md w-full text-center">
            ...
            <div className="mb-4 md:mb-6 flex justify-center">
              <div className="w-16 h-16 md:w-20 md:h-20 rounded-full bg-[#FFB6C1]/20 flex items-center justify-center">
                <AlertTriangle className="w-8 h-8 md:w-10 md:h-10 text-[#fd6698]" />
              </div>
            </div>

            {/* Error Message */}
            <h1 className="text-[#fd6698] mb-3 md:mb-4 break-words">Oops! Something went wrong</h1>
            <p className="text-[#fd6698]/70 mb-6 md:mb-8 break-words">
            ...
            {this.state.error && (
              <details className="mb-6 md:mb-8 text-left">
                ...
                <pre className="bg-[#FFF0F5] p-3 md:p-4 rounded-xl text-xs overflow-x-auto overflow-y-auto max-h-32 md:max-h-40 text-[#fd6698]/60 whitespace-pre-wrap break-words">
            ...
            <button
              ...
              className="bg-[#FFB6C1] hover:bg-[#fd6698] text-white px-6 md:px-8 py-2.5 md:py-3 rounded-full transition-all duration-300 hover:scale-105 hover:shadow-2xl flex items-center gap-2 mx-auto text-sm md:text-base"
            >
