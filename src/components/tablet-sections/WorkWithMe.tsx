...
export function WorkWithMe() {
  ...
  return (
    <div className="space-y-6 tablet-section">
      ...
      {/* Flexibility Section */}
      <div className="bg-gradient-to-br from-[#DDA0DD] to-[#C77DCD] rounded-2xl p-4 sm:p-6 border-2 border-white/20 shadow-lg">
        <div className="flex items-center gap-2 mb-3">
          <HelpCircle className="w-5 h-5 text-white" />
          <h4 className="text-white">{workWithMe.flexibility.title}</h4>
        </div>
        <p className="text-white/90 text-sm sm:text-base mb-4">{workWithMe.flexibility.message}</p>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 mb-4">
          {workWithMe.flexibility.options.map((option, i) => (
            <div key={i} className="flex items-start gap-2 bg-white/10 backdrop-blur-sm rounded-lg p-2 sm:p-3 text-white text-xs sm:text-sm">
              <CheckCircle2 className="w-4 h-4 flex-shrink-0 mt-0.5" />
              <span>{option}</span>
            </div>
          ))}
        </div>
        <p className="text-white/90 text-sm text-center italic">{workWithMe.flexibility.cta}</p>
      </div>
      ...
      <div className="bg-gradient-to-br from-[#87CEEB] to-[#6BA5D6] rounded-2xl p-6 sm:p-8 text-center shadow-lg">
        ...
        <p className="text-white/90 mb-3 text-sm sm:text-base">{workWithMe.cta.message}</p>
        <p className="text-white/80 mb-5 text-xs sm:text-sm italic">
        ...
        <form onSubmit={handleSubmit} className="space-y-4 text-left">
          ...
          {formState === 'error' && (
            <div className="bg-white/90 backdrop-blur-sm border-2 border-[#FFB6C1] text-gray-800 p-4 rounded-xl space-y-3">
              <p className="font-medium flex items-center justify-center gap-2 text-[#fd6698]">
              ...
              <a
                ...
                className="w-full py-3 bg-[#87CEEB] text-white rounded-xl hover:shadow-xl transition-all hover:scale-[1.02] flex items-center justify-center gap-2 text-sm sm:text-base font-medium"
              >
