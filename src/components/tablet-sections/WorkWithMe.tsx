...
import { Palette, Code, Sparkles, Lightbulb, Mail, Calendar, Clock, CheckCircle2, ArrowRight } from 'lucide-react';
    ...
    <div className="space-y-6 tablet-section">
      ...
      <div className="bg-gradient-to-br from-[#87CEEB] to-[#6BA5D6] rounded-2xl p-6 sm:p-8 text-center shadow-lg">
        ...
        <div className="flex flex-wrap justify-center gap-3">
          <StandardButton
            ...
            shortLabel="Start Project"
            variant="email"
          />
          <StandardButton
            href={`mailto:${workWithMe.cta.email}?subject=Free Consultation Request`}
            icon={Calendar}
            label={workWithMe.cta.secondary}
      ...
      <div className="bg-white/50 rounded-xl p-4 text-center border-2 border-[#FFB6C1]/20">
        <p className="text-sm text-gray-700">
          💡 <strong className="text-[#fd6698]">Fun Fact:</strong> Every project I work on gets a cute codename 
          (previous projects: "Project Bubblegum", "Operation Kawaii") 🌸
        </p>
      </div>
    </div>
  );
