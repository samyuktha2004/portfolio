...
export const Projects = React.memo(function Projects({ filter = 'all' }: ProjectsProps) {
  const filteredProjects = useMemo(() => {
    if (filter === 'development') {
      return projects.filter(project => project.projectType === 'dev');
    }
    if (filter === 'design') {
      return projects.filter(project => project.projectType === 'design');
    }
    return projects;
  }, [filter]);
