        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {resumeProjects.map((project, index) => (
            ...
            >
              ...
              <div className="absolute inset-0 bg-[#FFB6C1]/90 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity">
                <button className="px-6 py-3 bg-white text-[#FFB6C1] rounded-full">
                  View Project
                </button>
              </div>
            </div>
